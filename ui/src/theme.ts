...
const baseColors = {
  ...
  cssVariables: {
    ...
    "--lantern-bg-abyss": "#0A0A0F",
    "--lantern-bg-charcoal": "#111118",
    "--lantern-bg-illumination": "#1C1C28",
    "--lantern-bg-cave": "#2A2A3A",
    "--lantern-accent-ember": "#7C3AED",
    "--lantern-accent-glow": "#8B5CF6",
    "--lantern-accent-flicker": "#A78BFA",
    "--lantern-accent-heat": "#6D28D9",
    "--lantern-accent-ember-glow": "#7C3AED",
    "--lantern-accent-success": "#10B981",
    "--lantern-accent-warning": "#F59E0B",
    "--lantern-accent-danger": "#EF4444",
    "--lantern-accent-danger-light": "#FCA5A5",
    "--lantern-text-pure": "#FFFFFF",
    "--lantern-text-mid": "#C4C4D4",
    "--lantern-text-ash": "#8B8BA7",
    "--lantern-card-shadow": "0 1px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)",
    "--lantern-card-hover-shadow": "0 4px 16px rgba(0, 0, 0, 0.7), 0 2px 8px rgba(0, 0, 0, 0.5)",
  },
